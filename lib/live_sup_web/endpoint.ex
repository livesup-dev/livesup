defmodule LiveSupWeb.Endpoint do
  ...
  plug(Plug.Static,
    ...
    from: :live_sup,
    gzip: false,
    # only: ~w(assets fonts images favicon.ico robots.txt js css)
    only: LiveSupWeb.static_paths()
  )
  ...
  if code_reloading? do
    ...
    plug(Phoenix.Ecto.CheckRepoStatus, otp_app: :live_sup)
  end
