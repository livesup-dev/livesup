  ...
  def render(assigns) do
    ...
    <div class="border-b border-slate-150 py-3 dark:border-navy-500">
      <div class="items-center md:flex md:justify-between">
        <form phx-submit="add_task" class="w-full md:w-3/4 my-4 md:my-0 md:flex">
          <.hidden_input value={@todo.id} name="todo_id" />

          <label class="relative flex w-full md:w-3/4">
            <input
              type="text"
              name="title"
              placeholder="What needs to be done?"
              class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent pl-3 pr-9 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
            />
