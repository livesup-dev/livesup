  ...
  def render(assigns) do
    ...
    >
      <div x-show="!isSearchbarActive" class="flex items-center justify-between">
        <div x-show="isSearchbarActive" style="display: none;">
        ...
        <div class="flex items-start space-x-2">
          ...
          <label class="block relative flex ">
            <input
              class="w-full max-w-xs bg-transparent placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
              x-init="$el._tom = new TomSelect($el,{
                    ...
                    onItemRemove: function (val) {
                      $notification({text:`'${val}' filter removed`})
                    }
                  })"
              placeholder="Enter tags"
              type="text"
            />
            <span class="pointer-events-none absolute flex h-9 w-9 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
