defmodule LiveSupWeb.Todo.Components.TodoHeaderComponent do
  ...
  def render(assigns) do
    assigns =
      assigns
      |> assign(:priorities, Priorities.all())
                    ...
                    <li :for={priority <- @priorities}>
                      ...
                      >
                        <div class="avatar h-5 w-5">
                          <div class={"is-initial rounded-full border #{priority.color}"}>
                            <%= first_letter(priority.name) %>
                          </div>
                        </div>
                        <div>
  ...
  def first_letter(name), do: String.first(name)
end
