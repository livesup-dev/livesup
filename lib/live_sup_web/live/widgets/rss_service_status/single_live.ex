      ...
      <!-- RSS Service -->
        ...
        <div class="p-2">
          ...
          <% else %>
            ...
            <p class="text-center mt-2"><a target="_blank" href={widget_data.data.url} class="text-sm text-blue-500 hover:underline text-stone-400">Last incident: <%= widget_data.data.created_at_ago %></a></p>
          <% end %>
        </div>
        <!-- /Widget Content -->
      <!-- /RSS Service -->
