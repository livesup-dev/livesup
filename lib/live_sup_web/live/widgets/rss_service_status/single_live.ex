      ...
      <!-- RSS Service -->
        ...
        <div class="p-2">
          <%= if widget_data.data.status == :incident do %>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-20 w-20 m-auto" fill="none" viewBox="0 0 24 24" stroke="#F96C6C">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <p class="text-center mt-2"><a href={widget_data.data.url} target="blank" class="hover:underline"><%= widget_data.data.title %></a></p>
          <% else %>
            ...
            <p class="text-center mt-2"><a target="_blank" href={widget_data.data.url} class="text-blue-500 hover:underline text-stone-400">Last incident: <%= widget_data.data.created_at_ago %></a></p>
          <% end %>
        </div>
        <!-- /Widget Content -->
      <!-- /RSS Service -->
