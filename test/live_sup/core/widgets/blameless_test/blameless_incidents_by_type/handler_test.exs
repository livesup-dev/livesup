defmodule LiveSup.Test.Core.Widgets.Blameless.LastIncidents.HandlerTest do
  ...
  describe "Managing blameless last incidents" do
    @describetag :widget
    @describetag :blameless_last_incidents_widget
    @describetag :blameless_last_incidents_widget_handler
